// Ported from jimdinunzio/linorobot2_hardware (firmware/lib/traxxas_remctl)
// Reads two standard hobby-RC PWM channels (throttle+estop, steering) from a
// receiver, via pin-change interrupts. Generic Arduino API only (digitalRead,
// attachInterrupt, micros) - works unmodified on Teensy, ESP32 and RP2040
// (Pico/Pico2, earlephilhower core).

#ifndef TRAXXAS_REMCTL_H
#define TRAXXAS_REMCTL_H
