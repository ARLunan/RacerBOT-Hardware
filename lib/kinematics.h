...
{
    public:
        // NOTE: ACKERMANN added (ported from jimdinunzio/linorobot2_hardware)
        ...
        // NOTE: wheels_x_distance (front/rear wheel base) re-added, required for ACKERMANN.
        // Pass 0 for bases that don't use it (DIFFERENTIAL_DRIVE, SKID_STEER, MECANUM) -
        // it is simply ignored in those cases.
        ...
        // ACKERMANN-specific overload: computes velocities from current steering angle (rad)
        // and drive-wheel RPM.
