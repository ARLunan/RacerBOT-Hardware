...
// Assign your RC receiver channel pins in config.h (custom/<board>_config.h),
// e.g.  #define THROTTLE_IN_ESTOP_PIN 8
//       #define STEERING_IN_PIN      9
// Defaults below are only a fallback - always check they don't collide with
// I2C (SDA_PIN/SCL_PIN), encoder, or motor pins already used on your board.
#ifndef THROTTLE_IN_ESTOP_PIN
#define THROTTLE_IN_ESTOP_PIN 3
#endif
#ifndef STEERING_IN_PIN
